...
<body class="automove" id="deal-detail" data-com="pagecommon"
	...
	<header class="navbar">
		<span class="nav-header h1"
			style="background-color:red; font-size: 0.5rem;">欢迎您：${cacheChatUser.wechatUser.userNickName}</span>
	</header>
			...
			<dl style="opacity: 1;" id="deal-terms" class="list">
				...
				<dd class="dd-padding">
					<ul>
						<li>
							<div class="tip-title">
								<span style="color: blue">个人积分：<font color="blank">${cacheChatUser.wechatUser.userRewardPoint}</font></span>
							</div>
						</li>
						<li>
							<div class="tip-title">
								<span style="color: blue">关注商家数   : <font color="blank">${cacheChatUser.wechatUser.userRewardPoint}</font></span>
							</div>
						</li>
						<li>
							<div class="tip-title">
								<span style="color: blue">个人级别 : <font color="blank">${cacheChatUser.wechatUser.userLevel}</font></span>
							</div>
						</li>
						<li>
							<div class="tip-title">
								<span style="color: blue">注册时间 : <font color="blank">${cacheChatUser.wechatUser.userRegisterTime}</font></span>
							</div>
						</li>
					</ul>
				</dd>
