					...
					<ul>
					    ...
					    <li>
							...
							<div class="tip-des">
							    ...
							    <input class="span5" type="file" style="width: 30%" name="contentFile2"/>
							</div>
							<div class="tip-des">
							    <input class="span5" type="file" style="width: 30%" name="contentFile3"/>
							    <input class="span5" type="file" style="width: 30%" name="contentFile4"/>
							</div>
							<br/>
	...
	function showMessage(message,type,time) {
     ...
     function checkFinishTransaction(){
        	...
        	if(detail == '' || detail.length > 30){
           	...
           	if(temElement.value == ''){
        		showMessage("必须选择4张图片","error",2000);
        		temElement.focus();
        		return false;
           	}
           	...
           	temElement = newtransaction.contentFile3;
           	if(temElement.value == ''){
        		showMessage("必须选择4张图片","error",2000);
        		temElement.focus();
        		return false;
           	...
           	temElement = newtransaction.contentFile4;
           	if(temElement.value == ''){
        		showMessage("必须选择4张图片","error",2000);
        		temElement.focus();
        		return false;
