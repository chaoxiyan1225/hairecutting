...
.yongyin {width:150px;text-align:center;line-height:100%;padding:0.3em;font:16px Arial,sans-serif bold;font-style:normal;text-decoration:none;
        		...
        		<c:otherwise>
        		   <div class="oneTxt">
        			...
        			<c:forEach items="${queueInfos}" var="queueInfo">
        			 	<span >
            				排号码：${queueInfo.record.orderId} | 商家：${queueInfo.mchShopName}<button type="button" class="yongyin" onclick="cancelorder(${queueInfo.record.recordId})" style="width:100px; height:28px;">取消</button>
               			 </span>
               			 <br />
               			 <span>
