...
public class ParseRequest {
	...
	public static TbProduct generateNewProductInfo(HttpServletRequest request,
		...
		try {
			...
			logger.info("generateNewProductInfo,now system is in testmodel="+WinterOrangeSysConf.IS_TEST_VALID+",and pathPrefix="+pathPrefix);
			...
			newProduct.setProductHeadPicture(formFilds.get("headFile"));
	...
	public static TbMch generateNewMchInfo(HttpServletRequest request,
		...
		try {
			...
			logger.info("generateNewMchInfo,now system is in testmodel="+WinterOrangeSysConf.IS_TEST_VALID+",and pathPrefix="+pathPrefix);
	...
	public static TbTransactionRecord generateNewTransaction(HttpServletRequest request,
		...
		try {
			...
			logger.info("generateNewTransaction,now system is in testmodel="+WinterOrangeSysConf.IS_TEST_VALID+",and pathPrefix="+pathPrefix);
			formFilds = MuiltFileUploadUtil.parseRequestAndUploadFile(pathPrefix+
					IndexConfig.MCHUSER_PICTURE_TMEP_BASEPATH,pathPrefix+
					IndexConfig.MCHUSER_PICTURE_SAVE_BASEPATH,
					newFilePreFix, request);
